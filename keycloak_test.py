...
client_id="alchemybox",
realm_name="alchemybox",
client_secret_key="LeYOJ.SducR1Gy2l&H.%#9,=&8A-Wu-gDx*s-@t)1+JbV|p!BEbQThu&9GQ6$j;")

# Get WellKnow
config_well_know = keycloak_openid.well_know()
print(config_well_know)
# Get Token
token = keycloak_openid.token("test2", "test")
print(token)
